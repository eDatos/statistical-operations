...
@Component
public class MetamacCriteriaWebServiceInternal2SculptorCriteriaMapperImpl implements MetamacCriteriaWebServiceInternal2SculptorCriteriaMapper {

    @Autowired
    private WebServiceInternal2DoMapper                           webServiceInternal2DoMapper;

    private MetamacCriteriaWebService2SculptorCriteria<Operation> operationCriteriaMapper = null;

    public MetamacCriteriaWebServiceInternal2SculptorCriteriaMapperImpl() throws MetamacException {
    ...
    private class OperationCriteriaCallback implements CriteriaCallback {
        ...
        public SculptorPropertyCriteria retrieveProperty(MetamacCriteriaPropertyRestriction propertyRestriction) throws MetamacException {
            ...
            switch (propertyNameCriteria) {
                ...
                case PROC_STATUS:
                    ProcStatusEnum procStatusEnum = webServiceInternal2DoMapper.procStatusTypeToProcStatusEnum(ProcStatusType.valueOf(propertyRestriction.getStringValue()));
