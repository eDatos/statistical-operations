...
import org.siemac.metamac.statistical.operations.core.stream.messages.InstanceTypeAvro;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Component;

@Component
public class InstanceTypeDo2AvroMapper implements Do2AvroMapper<InstanceType, InstanceTypeAvro> {
    @Autowired
    InternationalStringDo2AvroMapper internationalStringDo2AvroMapper;

    @Override
    public InstanceTypeAvro toAvro(InstanceType source) {
        if (source == null) {
            return null;
        }
        return InstanceTypeAvro.newBuilder()
