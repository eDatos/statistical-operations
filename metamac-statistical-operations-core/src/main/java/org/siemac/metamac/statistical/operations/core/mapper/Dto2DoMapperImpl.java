...
public class Dto2DoMapperImpl implements Dto2DoMapper {
    ...
    public Family familyDtoToEntity(FamilyDto source, ServiceContext ctx) throws MetamacException {
        ...
        if (source.getId() != null) {
            ...
            if (!ProcStatusEnum.DRAFT.equals(target.getProcStatus())) {
                ...
                ValidationUtils.checkMetadataUnmodifiable(target.getCode(), source.getCode(), "FAMILY.CODE", exceptions);
    ...
    public Operation operationDtoToEntity(OperationDto source, ServiceContext ctx) throws MetamacException {
        ...
        if (source.getId() != null) {
            ...
            if (!ProcStatusEnum.DRAFT.equals(target.getProcStatus())) {
                List<MetamacExceptionItem> exceptions = new ArrayList<MetamacExceptionItem>();
                ValidationUtils.checkMetadataUnmodifiable(target.getCode(), source.getCode(), "OPERATION.CODE", exceptions);
                ExceptionUtils.throwIfException(exceptions);
            }
        }
    ...
    public Instance instanceDtoToEntity(InstanceDto source, ServiceContext ctx) throws MetamacException {
        ...
        if (source.getId() != null) {
            ...
            if (!ProcStatusEnum.DRAFT.equals(target.getProcStatus())) {
                List<MetamacExceptionItem> exceptions = new ArrayList<MetamacExceptionItem>();
                ValidationUtils.checkMetadataUnmodifiable(target.getCode(), source.getCode(), "INSTANCE.CODE", exceptions);
                ExceptionUtils.throwIfException(exceptions);
            }
        }
    ...
    private Family familyDtoToEntity(FamilyDto source, Family target) throws MetamacException {
        ...
        // ACRONYM
        target.setAcronym(internationalStringToEntity(source.getAcronym(), target.getAcronym(), "FAMILY.ACRONYM"));

        // DESCRIPTION
        target.setDescription(internationalStringToEntity(source.getDescription(), target.getDescription(), "FAMILY.DESCRIPTION"));
    ...
    private Operation operationDtoToEntity(OperationDto source, Operation target, ServiceContext ctx) throws MetamacException {
        ...
        // TITLE_ALETERNATIVE
        target.setAcronym(internationalStringToEntity(source.getAcronym(), target.getAcronym(), "OPERATION.ACRONYM"));
        ...
        // OBJECTIVE
        target.setObjective(internationalStringToEntity(source.getObjective(), target.getObjective(), "OPERATION.OBJECTIVE"));

        // DESCRIPTION
        target.setDescription(internationalStringToEntity(source.getDescription(), target.getDescription(), "OPERATION.DESCRIPTION"));
        ...
        // REL_POL_US_AC
        target.setRelPolUsAc(internationalStringToEntity(source.getRelPolUsAc(), target.getRelPolUsAc(), "OPERATION.REL_POL_US_AC"));
        ...
        // REV_POLICY
        target.setRevPolicy(internationalStringToEntity(source.getRevPolicy(), target.getRevPolicy(), "OPERATION.REV_POLICY"));

        // REV_POLICY_URL
        target.setRevPolicyUrl(source.getRevPolicyUrl());

        // REV_PRACTICE
        target.setRevPractice(internationalStringToEntity(source.getRevPractice(), target.getRevPractice(), "OPERATION.REV_PRACTICE"));
        ...
        // COMMENT
        target.setComment(internationalStringToEntity(source.getComment(), target.getComment(), "OPERATION.COMMENT"));

        // COMMENT_URL
        target.setCommentUrl(source.getCommentUrl());

        // NOTES
        target.setNotes(internationalStringToEntity(source.getNotes(), target.getNotes(), "OPERATION.NOTES"));
    ...
    private Instance instanceDtoToEntity(InstanceDto source, Instance target, ServiceContext ctx) throws MetamacException {
        ...
        // ACRONYM
        target.setAcronym(internationalStringToEntity(source.getAcronym(), target.getAcronym(), "INSTANCE.ACRONYM"));
        ...
        // DATA_DESCRIPTION
        target.setDataDescription(internationalStringToEntity(source.getDataDescription(), target.getDataDescription(), "INSTANCE.DESCRIPTION"));

        // STATISTICAL_POPULATION
        target.setStatisticalPopulation(internationalStringToEntity(source.getStatisticalPopulation(), target.getStatisticalPopulation(), "INSTANCE.STATISTICAL_POPULATION"));
        ...
        target.setGeographicComparability(internationalStringToEntity(source.getGeographicComparability(), target.getGeographicComparability(), "INSTANCE.GEOGRAPHIC_COMPARABILITY"));
        ...
        target.setTemporalComparability(internationalStringToEntity(source.getTemporalComparability(), target.getTemporalComparability(), "INSTANCE.TEMPORAL_COMPARABILITY"));
        ...
        // STAT_CONC_DEF
        target.setStatConcDef(internationalStringToEntity(source.getStatConcDef(), target.getStatConcDef(), "INSTANCE.STAT_CONC_DEF"));
        ...
        // CLASS_SYSTEM
        target.setClassSystem(internationalStringToEntity(source.getClassSystem(), target.getClassSystem(), "INSTANCE.CLASS_SYSTEM"));
        ...
        // DOC_METHOD
        target.setDocMethod(internationalStringToEntity(source.getDocMethod(), target.getDocMethod(), "INSTANCE.DOC_METHOD"));
        ...
        // DATA_VALIDATION
        target.setDataValidation(internationalStringToEntity(source.getDataValidation(), target.getDataValidation(), "INSTANCE.DATA_VALIDATION"));

        // DATA_VALIDATION_URL
        target.setDataValidationUrl(source.getDataValidationUrl());

        // DATA_COMPILATION
        target.setDataCompilation(internationalStringToEntity(source.getDataCompilation(), target.getDataCompilation(), "INSTANCE.DATA_COMPILATION"));

        // DATA_COMPILATION_URL
        target.setDataCompilationUrl(source.getDataCompilationUrl());

        // ADJUSTMENT
        target.setAdjustment(internationalStringToEntity(source.getAdjustment(), target.getAdjustment(), "INSTANCE.ADJUSTMENT"));

        // ADJUSTMENT_URL
        target.setAdjustmentUrl(source.getAdjustmentUrl());

        // COST_BURDEN
        target.setCostBurden(internationalStringToEntity(source.getCostBurden(), target.getCostBurden(), "INSTANCE.COST_BURDEN"));
        ...
        // QUALITY_DOC
        target.setQualityDoc(internationalStringToEntity(source.getQualityDoc(), target.getQualityDoc(), "INSTANCE.QUALITY_DOC"));

        // QUALITY_DOC_URL
        target.setQualityDocUrl(source.getQualityDocUrl());

        // QUALITY_ASSURE
        target.setQualityAssure(internationalStringToEntity(source.getQualityAssure(), target.getQualityAssure(), "INSTANCE.QUALITY_ASSURE"));

        // QUALITY_ASSURE_URL
        target.setQualityAssureUrl(source.getQualityAssureUrl());

        // QUALITY_ASSMNT
        target.setQualityAssmnt(internationalStringToEntity(source.getQualityAssmnt(), target.getQualityAssmnt(), "INSTANCE.QUALITY_ASSMNT"));

        // QUALITY_ASSMNT_URL
        target.setQualityAssmntUrl(source.getQualityAssmntUrl());

        // USER_NEEDS
        target.setUserNeeds(internationalStringToEntity(source.getUserNeeds(), target.getUserNeeds(), "INSTANCE.USER_NEEDS"));

        // USER_NEEDS_URL
        target.setUserNeedsUrl(source.getUserNeedsUrl());

        // USER_SAT
        target.setUserSat(internationalStringToEntity(source.getUserSat(), target.getUserSat(), "INSTANCE.USER_SAT"));

        // USER_SAT_URL
        target.setUserSatUrl(source.getUserSatUrl());

        // COMPLETENESS
        target.setCompleteness(internationalStringToEntity(source.getCompleteness(), target.getCompleteness(), "INSTANCE.COMPLETENESS"));

        // COMPLETENESS_URL
        target.setCompletenessUrl(source.getCompletenessUrl());

        // TIMELINESS
        target.setTimeliness(internationalStringToEntity(source.getTimeliness(), target.getTimeliness(), "INSTANCE.TIMELINESS"));

        // TIMELINESS_URL
        target.setTimelinessUrl(source.getTimelinessUrl());

        // PUNCTUALITY
        target.setPunctuality(internationalStringToEntity(source.getPunctuality(), target.getPunctuality(), "INSTANCE.PUNCTUALITY"));

        // PUNCTUALITY_URL
        target.setPunctualityUrl(source.getPunctualityUrl());

        // ACCURACY_OVERALL
        target.setAccuracyOverall(internationalStringToEntity(source.getAccuracyOverall(), target.getAccuracyOverall(), "INSTANCE.ACCURACY_OVERALL"));

        // ACCURACY_OVERALL_URL
        target.setAccuracyOverallUrl(source.getAccuracyOverallUrl());

        // SAMPLING_ERR
        target.setSamplingErr(internationalStringToEntity(source.getSamplingErr(), target.getSamplingErr(), "INSTANCE.SAMPLING_ERR"));

        // SAMPLING_ERR_URL
        target.setSamplingErrUrl(source.getSamplingErrUrl());

        // NONSAMPLING_ERR
        target.setNonsamplingErr(internationalStringToEntity(source.getNonsamplingErr(), target.getNonsamplingErr(), "INSTANCE.NONSAMPLING_ERR"));

        // NONSAMPLING_ERR_URL
        target.setNonsamplingErrUrl(source.getNonsamplingErrUrl());

        // COHER_X_DOMAIN
        target.setCoherXDomain(internationalStringToEntity(source.getCoherXDomain(), target.getCoherXDomain(), "INSTANCE.COHER_X_DOMAIN"));

        // COHER_X_DOMAIN_URL
        target.setCoherXDomainUrl(source.getCoherXDomainUrl());

        // COHER_INTERNAL
        target.setCoherInternal(internationalStringToEntity(source.getCoherInternal(), target.getCoherInternal(), "INSTANCE.COHER_INTERNAL"));

        // COHER_INTERNAL_URL
        target.setCoherInternalUrl(source.getCoherInternalUrl());

        // COMMENT
        target.setComment(internationalStringToEntity(source.getComment(), target.getComment(), "INSTANCE.COMMENT"));

        // COMMENT_URL
        target.setCommentUrl(source.getCommentUrl());

        // NOTES
        target.setNotes(internationalStringToEntity(source.getNotes(), target.getNotes(), "INSTANCE.NOTES"));
