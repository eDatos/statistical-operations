...
public interface StatisticalOperationsRestInternalFacadeV10 {
     ...
     *            INTERNAL_INVENTORY_DATE, CURRENTLY_ACTIVE, STATUS, PROC_STATUS, PUBLISHER_URN, INVENTORY_DATE <br/>
     *            - Example: (ID LIKE "Operation1" AND PROC_STATUS EQ "PUBLISH_INTERNALLY") OR (ACRONYM EQ "Op1") OR (INVENTORY_DATE IS_NULL)
     ...
     *            - Logical operators: AND, OR <br/>
     *            - Comparison operators: EQ, IEQ, LIKE, ILIKE, NE, LT, LE, GT, GE, IS_NULL, IS_NOT_NULL, IN <br/>
     *            - Metadata to filter: ID, URN, TITLE, ACRONYM, DATA_DESCRIPTION, GEOGRAPHIC_GRANULARITY_URN, TEMPORAL_GRANULARITY_URN, INSTANCE_TYPE_ID, INTERNAL_INVENTORY_DATE, PROC_STATUS,
     *            INVENTORY_DATE <br/>
     *            - Example: (ID LIKE "Instance1" AND PROC_STATUS EQ "PUBLISH_INTERNALLY") OR (ACRONYM EQ "Instance1") OR (INVENTORY_DATE IS_NULL)
     * @param orderBy Clause to order the results by metadata <br/>
     *            - Order operators: ASC, DESC<br/>
     *            - Metadata to order: ID<br/>
     *            - Example: ID ASC<br/>
     ...
     *            - Logical operators: AND, OR <br/>
     *            - Comparison operators: EQ, IEQ, LIKE, ILIKE, NE, LT, LE, GT, GE, IS_NULL, IS_NOT_NULL, IN <br/>
     *            - Metadata to filter: ID, URN, TITLE, ACRONYM, DESCRIPTION, INTERNAL_INVENTORY_DATE, PROC_STATUS, INVENTORY_DATE <br/>
     *            - Example: (ID LIKE "Family1" AND PROC_STATUS EQ "PUBLISH_INTERNALLY") OR (ACRONYM EQ "Family1") OR (INVENTORY_DATE IS_NULL)
     * @param orderBy Clause to order the results by metadata <br/>
     *            - Order operators: ASC, DESC<br/>
     *            - Metadata to order: ID<br/>
     *            - Example: ID ASC<br/>
