...
public class Do2RestExternalMapperV10Impl implements Do2RestExternalMapperV10 {
    ...
    private String                           srmExternalApiEndpoint;
    ...
    public void init() throws Exception {
        ...
        // Srm Api
        srmExternalApiEndpoint = configurationService.getProperty(RestEndpointsConstants.SRM_EXTERNAL_API);
        if (srmExternalApiEndpoint == null) {
    ...
    private void toResourcesExternalItemsSrm(Set<ExternalItem> sources, List<Resource> targets) {
        toResourcesExternalItems(sources, targets, srmExternalApiEndpoint);
    }
    ...
    private Resource toResourceExternalItemSrm(ExternalItem source) {
        ...
        return toResourceExternalItem(source, srmExternalApiEndpoint);
    }
    ...
    private String toOperationsLink(String apiUrl) {
        return RestUtils.createLink(apiUrl, RestExternalConstants.LINK_SUBPATH_OPERATIONS);
    }
    ...
    private String toFamiliesLink(String apiUrl) {
        return RestUtils.createLink(apiUrl, RestExternalConstants.LINK_SUBPATH_FAMILIES);
    }
