...
public class SearchMultipleDataProvidersItem extends SearchMultipleSrmItemsItem {
    ...
    public SearchMultipleDataProvidersItem(String name, String title, MultipleExternalResourceAction action) {
        super(name, title, RestWebCriteriaUtils.buildItemSchemeWebCriteria(DATA_PROVIDER_SCHEME), RestWebCriteriaUtils.buildItemWebCriteria(new SrmItemRestCriteria(),
                new TypeExternalArtefactsEnum[]{DATA_PROVIDER}), getConstants().searchOrganisations(), getConstants().filterOrganisationScheme(), getConstants().selectedOrganisationScheme(),
