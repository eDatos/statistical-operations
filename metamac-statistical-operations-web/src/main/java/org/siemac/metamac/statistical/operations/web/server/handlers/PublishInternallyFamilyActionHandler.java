...
@Component
public class PublishInternallyFamilyActionHandler extends SecurityActionHandler<PublishInternallyFamilyAction, PublishInternallyFamilyResult> {
    ...
    @Override
    public PublishInternallyFamilyResult executeSecurityAction(PublishInternallyFamilyAction action) throws ActionException {
        try {
