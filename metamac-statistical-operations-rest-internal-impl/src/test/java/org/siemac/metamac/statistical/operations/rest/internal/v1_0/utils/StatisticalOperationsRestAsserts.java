...
public class StatisticalOperationsRestAsserts {
    ...
    public static void assertEqualsOperation(Operation expected, Operation actual) {
        ...
        MetamacRestAsserts.assertEqualsResource(expected.getSurveyType(), actual.getSurveyType());
        MetamacRestAsserts.assertEqualsResource(expected.getOfficialityType(), actual.getOfficialityType());
    ...
    public static void assertEqualsInstance(Instance expected, Instance actual) {
        ...
        MetamacRestAsserts.assertEqualsResource(expected.getInstanceType(), actual.getInstanceType());
        assertEquals(expected.getInternalInventoryDate(), actual.getInternalInventoryDate());
        assertEquals(expected.getProcStatus(), actual.getProcStatus());
        MetamacRestAsserts.assertEqualsInternationalString(expected.getDocMethod(), actual.getDocMethod());
        MetamacRestAsserts.assertEqualsResource(expected.getSurveySource(), actual.getSurveySource());
        MetamacRestAsserts.assertEqualsResource(expected.getCollMethod(), actual.getCollMethod());
        ...
        MetamacRestAsserts.assertEqualsResources(expected.getCosts(), actual.getCosts());
        assertEquals(expected.getInventoryDate(), actual.getInventoryDate());
