...
public class StatisticalOperationsRestInternalFacadeV10Test extends MetamacRestBaseTest {
    ...
    private static String                                     statisticalOperationsInternalWebApplication;
    private static String                                     srmInternalWebApplication;
    private static String                                     srmApiInternalEndpoint;
    ...
    public void testFindOperationsByFamilyXml() throws Exception {

        {
            ...
            StatisticalOperationsRestAsserts.assertEqualsOperations(statisticalOperationsRestMocks.mockOperationsByFamily1(limit, offset), operations);
        }
        {
            // without limits, first page
            String limit = "10000";
        ...
        }
        {
            ...
            StatisticalOperationsRestAsserts.assertEqualsOperations(statisticalOperationsRestMocks.mockOperationsByFamily2(limit, offset), operations);
        }
        {
            // last page, with pagination
            String limit = "2";
    ...
    public void testFindFamiliesXml() throws Exception {

        {
            ...
            StatisticalOperationsRestAsserts.assertEqualsFamilies(statisticalOperationsRestMocks.mockFamilies(limit, offset), families);
        }
        {
            // without limits, first page
            String limit = "10000";
        ...
        // Queries
        {
            ...
            String orderBy = null;
            Families families = getStatisticalOperationsRestInternalFacadeClientXml().findFamilies(query, orderBy, limit, offset);
            StatisticalOperationsRestAsserts.assertEqualsFamilies(statisticalOperationsRestMocks.mockFamilies(limit, offset, query), families);
        }
        {
            // query by id, first page
            String limit = "1";
    ...
    public void testRetrieveStatisticalOperationTypesXml() throws Exception {
        ...
        // Retrieve
        StatisticalOperationTypes statisticalOperationTypes = getStatisticalOperationsRestInternalFacadeClientXml().retrieveStatisticalOperationTypes();
    ...
    public void testRetrieveStatisticalOperationTypesXmlWithoutJaxbTransformation() throws Exception {
        ...
        InputStream responseExpected = StatisticalOperationsRestInternalFacadeV10Test.class.getResourceAsStream("/responses/retrieveStatisticalOperationTypes.xml");
    ...
    public void testRetrieveStatisticalOperationSourcesXml() throws Exception {
        ...
        // Retrieve
        StatisticalOperationSources statisticalOperationSources = getStatisticalOperationsRestInternalFacadeClientXml().retrieveStatisticalOperationSources();
    ...
    public void testRetrieveStatisticalOperationSourcesXmlWithoutJaxbTransformation() throws Exception {
        ...
        InputStream responseExpected = StatisticalOperationsRestInternalFacadeV10Test.class.getResourceAsStream("/responses/retrieveStatisticalOperationSources.xml");
