...
public class StatisticalOperationsRestMocks {
    ...
    private ResourceInternal mockOperationResource(String subId) {
        ...
        resource.setTitle(mockInternationalString("es", operationId + " en Español"));
        return resource;
    }
    ...
    private ResourceInternal mockFamilyResource(String subId) {
        ...
        resource.setTitle(mockInternationalString("es", familyId + " en Español"));
        return resource;
    }
    ...
    private ResourceInternal mockInstanceResource(String operationId, String subId) {
        ...
        resource.setTitle(mockInternationalString("es", instanceId + " en Español"));
        return resource;
    }
    ...
    private Instance mockInstance(String subId, String operation, ProcStatus procStatus) {
        ...
        instance.getGeographicGranularity().setKind(Do2RestInternalMapperV10Impl.KIND_SRM_EXTERNAL_ITEM);
        ...
        instance.getTemporalGranularity().setKind(Do2RestInternalMapperV10Impl.KIND_SRM_EXTERNAL_ITEM);
