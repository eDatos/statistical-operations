...
CREATE TABLE TB_EXTERNAL_ITEMS (
  ...
  URN VARCHAR(4000) NOT NULL,
  MANAGEMENT_APP_URL VARCHAR(255),
  VERSION BIGINT NOT NULL,
  TITLE_FK BIGINT,
...
CREATE TABLE TB_INSTANCES (
  ...
  GEOGRAPHIC_GRANULARITY_FK BIGINT,
  GEOGRAPHIC_COMPARABILITY_FK BIGINT,
  TEMPORAL_GRANULARITY_FK BIGINT,
...
;
ALTER TABLE TB_INSTANCES ADD CONSTRAINT FK_TB_INSTANCES_GEOGRAPHIC_GRANULARITY_FK
...
;
ALTER TABLE TB_INSTANCES ADD CONSTRAINT FK_TB_INSTANCES_TEMPORAL_GRANULARITY_FK
