...
CREATE TABLE TB_INSTANCES (
  ...
  GEOGRAPHIC_GRANULARITY_FK NUMBER(19),
  GEOGRAPHIC_COMPARABILITY_FK NUMBER(19),
  TEMPORAL_GRANULARITY_FK NUMBER(19),
...
;
ALTER TABLE TB_INSTANCES ADD CONSTRAINT FK_TB_INSTANCES_GEOGRAPHIC_G92
...
;
ALTER TABLE TB_INSTANCES ADD CONSTRAINT FK_TB_INSTANCES_TEMPORAL_GRA11
