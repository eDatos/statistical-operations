...
scp -o ProxyCommand="ssh -W %h:%p deploy@estadisticas.arte-consultores.com" metamac-statistical-operations-web/target/statistical-operations-internal-*.war deploy@192.168.10.16:$TRANSFER_PATH/statistical-operations-internal.war
scp -o ProxyCommand="ssh -W %h:%p deploy@estadisticas.arte-consultores.com" metamac-statistical-operations-external-web/target/statistical-operations-*.war deploy@192.168.10.16:$TRANSFER_PATH/statistical-operations.war
